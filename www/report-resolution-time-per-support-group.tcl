# /packages/intranet-sla-management/www/report-resolution-time-per-support-group.tcl
#
...
ad_page_contract {
    Resolution Time per Support Group

    This report shows ticket information (resolution time) for the
    people serving tickets.
...
set page_title "Resolution Time per Support Group"
set context_bar [im_context_bar $page_title]
set help_text "
	<strong>$page_title:</strong><br>
	Shows the resolution time per ticket, grouped by
	resolution user and resolution user group
"
